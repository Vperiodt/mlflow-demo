...
class Registry(BaseRegistry):
    ...
    def record_training_run(
        ...
        """Record a training run in the registry for lineage tracking."""
    ...
    def list_training_runs(
        ...
        """List training runs from the registry."""
        registry_proto = self._get_registry_proto(project=project, allow_cache=allow_cache)
        runs = list(registry_proto.training_runs)
        if feature_service_name:
            runs = [r for r in runs if r.feature_service_name == feature_service_name]
        return runs
