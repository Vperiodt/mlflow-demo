...
class FeatureStore:
    ...
    def get_historical_features(
        ...
        self._emit_mlflow_historical_features(
            features, feature_views, _feature_refs
        )

        return job

    def _emit_mlflow_historical_features(
        self,
        features_input: Any,
        feature_views: list,
        ...
        try:
            ...
            elif isinstance(features_input, str):
                fs_name = features_input
