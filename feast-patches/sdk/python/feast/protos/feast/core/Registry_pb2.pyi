...
class Registry(_message.Message):
    ...
    @_builtins.property
    def training_runs(self) -> _containers.RepeatedCompositeFieldContainer[Global___TrainingRunMetadata]: ...
    def __init__(
        self,
        *,
...
class TrainingRunMetadata(_message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        feature_service_name: _builtins.str = ...,
        project: _builtins.str = ...,
        feature_refs: _abc.Iterable[_builtins.str] | None = ...,
    ...
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["created_at", b"created_at", "experiment_name", b"experiment_name", "feature_refs", b"feature_refs", "feature_service_name", b"feature_service_name", "project", b"project", "run_id", b"run_id", "tags", b"tags", "tracking_uri", b"tracking_uri"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...

Global___TrainingRunMetadata: _TypeAlias = TrainingRunMetadata  # noqa: Y015
